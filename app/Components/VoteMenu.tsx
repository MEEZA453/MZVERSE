...
router.back() 
    ...
    return  <motion.div  initial = {{opacity : 0}} animate = {{opacity : 1}} transition={{duration: 0.3 , }} className="h-screen w-screen z-[999] fixed left-0 bottom-0 bg-black/50">
      ...
      <motion.div  initial = {{y : 160 }} transition = {{duration : 0.3 , ease : "easeInOut"} } exit={{y : 160}} animate = {{y : 0}}  className="bg-[#151515] fixed  z-200  bottom-3 lg:bottom-4 py-4 -translate-x-1/2 left-1/2  flex  flex-col items-center justify-center lg:w-80 w-[96%] rounded-[6px]  ">
