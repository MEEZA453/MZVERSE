...
const router = useRouter()
      ...
      <motion.div  initial = {{y : 160}} transition = {{duration : 0.3 , ease : "easeInOut"} } exit={{y : 160}} animate = {{y : 0}}  className="bg-[#0d0d0d] fixed  z-[99999] bottom-0 py-4 border-t border-[#2d2d2d] flex  flex-col items-center justify-center  w-screen  ">
  <button
      onClick={()=>router.push('/createPost')}
      className=" text-white w-full  px-3 py-2  border-b border-[#2d2d2d]  gap-1"
      >
  <div className=" gap-1 flex items-center justify-center w-full"><h6  >Share your vision</h6><FiEdit3/></div>
