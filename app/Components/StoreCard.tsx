...
export default function PostCard({product}){
    ...
    return        <div className="mb-2" > <div
            ...
            className="group relative flex flex-col items-center justify-between  overflow-hidden  bg-[#0d0d0d] border-[#1d1d1d] border rounded h-30 w-[43vw] lg:w-full  lg:h-100 min-h-[200px]"
          >
...
{/* {product?.image && product?.image?.length > 0 ? (
  <Image
    ...
    alt="dff"
    src={product?.image[0]}
    className="w-[30vw] h-fit object-cover lg:mb-4 lg:w-[15vw]"
    priority
  />
) : null} */}
            ...
            height={300}
            width={300}
            alt='fdfdf'  className='h-7 w-7 rounded-full items-center object-cover' src={product?.createdBy?.profile || '/image.png'}/></button>  
