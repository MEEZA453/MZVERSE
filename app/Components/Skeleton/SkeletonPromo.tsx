export function SkeletonPromoCard() {
  return (
    <div className="flex-shrink-0 w-[80vw] lg:w-[33.33vw] mb-4 snap-center relative">
      {/* Image placeholder */}
      <div className="w-full h-[22rem] lg:h-[40rem] bg-[#1d1d1d] rounded animate-pulse" />
      ...
      <div className="flex justify-between items-center w-full z-[99] absolute top-2 left-2 pr-3">
        <div className="flex items-center gap-2">
          {/* Avatar */}
          <div className="h-8 w-8 rounded-full bg-[#1d1d1d] animate-pulse" />
          <div className="flex flex-col gap-1">
            <div className="h-2.5 w-24 bg-[#1d1d1d]  animate-pulse" />
            <div className="h-1.5 w-16 bg-[#1d1d1d]  animate-pulse" />
          </div>
        </div>
      </div>
    </div>
