...
return <div className="relative h-12 w-12">
   ...
   <div className="h-12 w-12 bg-[#1d1d1d] flex justify-center items-center ">
                             <Image onClick={()=>setAttachmentsMenu(true)} src={coverImage} height={100} width={100}  alt="preview" className="h-9  lg:h-11 w-fit lg:w-10  rounded-[2px] object-cover"/></div>
</div>
}