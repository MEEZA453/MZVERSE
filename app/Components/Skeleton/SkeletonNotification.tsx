...
export default function SkeletonNotification() {
  return (
    <div className="w-full space-y-0.5">
      ...
      <div className="h-12 w-full bg-[#151515] flex items-center gap-2 rounded px-2 animate-pulse">
      ...
      <div className="h-16 w-full bg-[#151515] flex justify-between items-center rounded px-2 animate-pulse">
