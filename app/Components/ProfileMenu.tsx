...
useEffect(()=>{
  ...
  animate={{ y: 0}}
  exit={ {y: 160}}
  transition={ { duration: 0.3 }}  className="bg-[#151515] fixed lg:absolute lg:w-60 lg:top-22 lg:right-[26.1vw] lg:h-fit lg: z-[99999] bottom-4 py-4 max-sm:-translate-x-1/2 max-sm:left-1/2  flex  flex-col items-center justify-center  w-[96%] rounded-[6px]   ">
  {/* <button
