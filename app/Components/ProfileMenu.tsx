...
useEffect(()=>{
  ...
  exit={isMobile ? { y: 160 } : {}}
  transition={isMobile ? { duration: 0.3, ease: "easeInOut" } : {}}  className="bg-[#0d0d0d] fixed lg:absolute lg:w-60 lg:top-22 lg:right-[26.1vw] lg:h-fit lg: z-[99999] bottom-1.5 py-4 max-sm:-translate-x-1/2 max-sm:left-1/2  flex  flex-col items-center justify-center  w-[96%] rounded-[6px]   ">
  {/* <button
