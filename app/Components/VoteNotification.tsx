...
const {isLightMode} = useThemeContext()
    ...
    return <motion.div       className={`h-12 w-full ${isLightMode ? 'bg-[#ededed]': 'bg-[#151515]'} mb-0.5  justify-between items-center  flex px-2`}><div className="flex items-center gap-1 ">
