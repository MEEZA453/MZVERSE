...
export default function PostCard({post}){
    ...
    return        <div className="mb-2" > <div
            ...
            className="group relative flex flex-col items-center justify-center  overflow-hidden  bg-[#0d0d0d] border-[#1d1d1d] border rounded h-30 w-[45vw] lg:w-full  lg:h-100 min-h-[200px]"
          >
